...
import { i as PageHeader, r as Icon, t as AppShell } from "./AppShell-CHdJzBdJ.mjs";
import { i as Modal } from "./ui-kit-D18jqlXM.mjs";
import { t as Api } from "./api-BumNLaxK.mjs";
import { t as toast } from "../_libs/sonner.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/credit.cases-BmYa42IB.js
...
function CaseRegistry() {
	...
	const kpis = [
		...
		},
		{
			...
			tag: pendingCases.length ? "Action needed" : "Clear",
			tagClass: pendingCases.length ? "text-error" : "text-secondary",
			note: "Awaiting auctioneer assignment"
		},
		{
			label: "AVG. DPD",
			icon: "schedule",
		...
		},
		{
			...
			tag: "In process",
			tagClass: "text-secondary",
			note: "Active outstanding principal"
		}
	];
		...
		children: [
				...
				children: [
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
										value: "all",
										children: "Branch: All"
									}), Array.from(new Set(rows.map((row) => row.branch))).map((branch) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("option", {
										value: branch,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: ["LAST UPDATED: ", loading ? "Loading..." : (/* @__PURE__ */ new Date()).toLocaleString()]
						})]
					})
				]
			}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					className: "space-y-2",
					children: [rows.slice(0, 3).map((row) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex justify-between text-body-sm",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: "text-on-surface-variant text-mono-data",
							children: [
								new Date(cases.find((item) => item.id === row.id)?.created_at).toLocaleString(),
								" - Recovery case ",
								row.case_number,
								" created for ",
								row.name,
					...
					}, row.id)), !loading && !rows.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-body-sm text-on-surface-variant",
						children: "No case activity recorded yet."
					}) : null]
				})]
			}),
