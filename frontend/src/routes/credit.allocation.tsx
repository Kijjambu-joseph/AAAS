...
function AllocationEngine() {
  ...
  async function allocate(caseId: number) {
    ...
    await Api.post(`/api/cases/${caseId}/allocate/`, { auctioneer_id: auctioneer.id, method: "Manual" });
    await refresh();
  }
